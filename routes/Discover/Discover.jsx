...
function Discover(){
    ...
    const url = `https://api.maptiler.com/geocoding/${search}.json?key=nmO3tm51a8nrPeztTcc7`;
  ...
  if (!isLoaded) {
    ...
    return (
        <>
                ...
                <Typography variant="h3" className={classes.typographyStyle} marginTop="1em" marginBottom="1em"  sx={{ ml: { xs: 35, sm: 45 } }}> Discover the places around you</Typography> 
                ...
                <List places={filteredPlaces.length > 0 ? filteredPlaces : places}
                    rating={rating}
                    setRating={setRating}
                    isLoading={isLoading}
                    />
